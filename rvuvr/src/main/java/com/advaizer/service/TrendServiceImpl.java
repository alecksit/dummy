...
public class TrendServiceImpl implements TrendService {
	...
	public HashMap<String,Long> getRoamingStatistics(final Filter filter, final String roamType)
	{
		...
		final List<RoamingStatistics> roamingStatisticslist= trendRepository
				.getRoamingStatisticsOnly(filter, roamType);
		...
		final List<RoamingStatistics> distinctRoamingStatisticslist= trendRepository
				.getDistinctRoamingStatisticsOnly(filter, roamType);
		
		for(final RoamingStatistics roamingStatistics : distinctRoamingStatisticslist ){
			roamingStatisticsMap.put("totalRoamer",roamingStatistics.getRoamerTotal() );
