...
<!-- Mirrored from www.pxcreate.com/bootstrap/classic/register.html by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 14 Jul 2015 12:02:47 GMT -->
<head>
  ...
  <div class="container"> 
    ...
    <div class="mt40 row">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <h5 class="heading5">Category Information</h5>
        <div class="loginbox">
          <form class="form-vertical">
            <fieldset>
              ...
              <div class="control-group">
                <label  class="control-label">Parent Category Id:</label>
                <div class="controls">
                  <input type="text">
                </div>
              </div>
              ...
              <br>
              <a class="btn btn-orange">Submit</a>
            </fieldset>
          </form>
        </div>
      </div>
