...
<!--<section id="searchmap">
    <div id="indexmap"></div>
    <div class="container"> <a href="post-ad.html" class="postad"><span> <i class="fa fa-pencil"></i> Post An Ad</span></a>
      <div class="searchcontianer" id="searchinner"> <a class="todayoffer"><span class="text1">Today's Offer</span><span class="text2">50% OFF</span></a>
        ...
        <form class="form-inline">
          <div class="btn-group" id="search-group"> 
            <!-- <input type="search" id="keyword" name="keyword" value="" placeholder="Search Location" class="form-control mainserarch">           

<select id="category" name="cagegory">
  ...
  <option value="Health">Health</option>
            ...
            <input id="searchmap"  type="submit" value="Search" class="btn btn-orange tooltip-test mainserarchsubmit">
            
            <input type="text" id="keyword" name="keyword" value="" placeholder="Search Location" class="form-control mainserarch" />
            <select id="category" name="cagegory">
              <option value="">All Categories</option>
              <option value="Real Estate">Real Estate</option>
              <option value="Jobs">Jobs</option>
            ...
            <input type="button" id="searchmapbutton" name="search" value="Search" class="btn btn-orange tooltip-test mainserarchsubmit"/>
          </div>
        </form>
      </div>
    </div>
...
<div class="container mt20">
	<div class="seodetails">
		<h2 class="heading2">RVUVR - 3 Easy Steps.</h2>
		<p class="metadetails">
			Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce
			elementum, nulla vel pellentesque consequat, <br> ante nulla
			hendrerit arcu, ac tincidunt mauris lacus sed leo. vamus suscipit
			molestie vestibulum.
		</p>
	</div>
</div>
...
<div class="container">
	<div class="row">
		<ul class="steps">
			<li class="col-sm-4">
				<div class="step">
					<span class="stepcount">1</span><span>Select Category</span> <i
						class="fa fa-check-square-o pull-right"></i>
				</div>
			</li>
			<li class="col-sm-4">
				<div class="step">
					<span class="stepcount">2</span><span>Search </span> <i
						class="fa fa-edit pull-right"></i>
				</div>
			</li>
			<li class="col-sm-4">
				<div class="step">
					<span class="stepcount">3</span><span>Review</span> <i
						class="fa fa-credit-card pull-right"></i>
				</div>
			</li>
		</ul>
	</div>
...
<div class="container mt40" id="maincategory">
	<ul class="maincategory row">
		...
		<li><a href="listing.html"><i class="fa fa-thumbs-o-up c3"></i>
				<br> <span class="direname">Services</span></a></li>
		<li><a href="listing.html"> <i class="fa fa-desktop c16"></i>
				<br> <span class="direname">Computers</span></a></li>
		<li><a href="listing.html"><i class="fa fa-suitcase c4"></i>
				<br> <span class="direname">Jobs</span></a></li>
		<li><a href="listing.html"> <i class="fa fa-female c13"></i>
				<br> <span class="direname">Beauty</span></a></li>
		<li><a href="listing.html"><i class="fa fa-glass c10"></i> <br>
				<span class="direname">Hobbies</span></a></li>
		<li><a href="listing.html"> <i class="fa fa-video-camera c6"></i>
				<br> <span class="direname">Movies</span></a></li>
		...
		<li><a href="listing.html"> <i class="fa fa-cutlery c14"></i>
				<br> <span class="direname">Food</span></a></li>
		<li><a href="listing.html"><i class="fa fa-camera c15"></i> <br>
				<span class="direname">Cameras</span></a></li>
		<li><a href="listing.html"> <i class="fa fa-building-o c11"></i>
				<br> <span class="direname">Furniture</span></a></li>
		<li><a href="listing.html"><i class="fa fa-lightbulb-o c17"></i>
				<br> <span class="direname"> Electronics</span></a></li>
	</ul>
	<div class="clearfix"></div>
	<a id="prevcat" class="prevcarousal" href="#">Previous</a> <a
		id="nextcat" class="nextcarosal" href="#">Next</a>
</div>
<!-- Directory Listing-->
		...
		<ul class="row clearfix">
			<li class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<section class="directorylist">
					<div>
						<i class="fa fa-plane"></i><span class="directorytitle">Vehicle</span>
					</div>
					<ul class="list">
				...
				<section class="directorylist">
					<div>
						<i class="fa fa-home"></i><span class="directorytitle">Fore
							Rent</span>
					</div>
					<ul class="list">
				...
				<section class="directorylist">
					<div>
						<i class="fa fa-twitter"></i><span class="directorytitle">Pets</span>
					</div>
					<ul class="list">
			...
			<li class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<section class="directorylist">
					<div>
						<i class="fa fa-thumbs-o-up"></i><span class="directorytitle">Sevices</span>
					</div>
					<ul class="list">
				...
				<section class="directorylist">
					<div>
						<i class="fa fa-user"></i><span class="directorytitle">Personal</span>
					</div>
					<ul class="list">
				...
				<section class="directorylist">
					<img src="img/ad1.jpg" alt="" title="">
				</section>
			</li>
			<li class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<section class="directorylist">
					<div>
						<i class="fa fa-users"></i><span class="directorytitle">Community</span>
					</div>
					<ul class="list">
				...
				<section class="directorylist">
					<div>
						<i class="fa fa-suitcase"></i><span class="directorytitle">Jobs</span>
					</div>
					<ul class="list">
			...
			<li class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				...
				<section class="directorylist ">
					<div>
						<i class="fa fa-dollar"></i><span class="directorytitle">Items
							for Sale</span>
					</div>
					<ul class="list">
			...
			<ul class="mt30 clearfix row">
				<li class="col-sm-3">
					<div class="searchgrid">
						<a class="thumbnail" href="detail.html"><img
							src="img/product1.jpg" alt=""></a>
						<div class="featured">Featured</div>
						<div>
							<h3>
								<a class="title" href="#">Samsung Galaxy Tab 3 T211 Tablet </a>
							</h3>
							<ul class="icondetail">
								<li><i class="fa fa-th-list"></i> Category : <a href="#">Mobile</a></li>
								<li><i class="fa fa-map-marker"></i> Location : California,
									U.S.</li>
								<li><i class="fa fa-calendar"></i> Posted On : Mach 22,
									2014</li>
						...
						<div>
							<div class="share">
								Share On : <a data-original-title="Facebook"
									class="tooltip-test"><i class="fa fa-facebook"></i></a> <a
									data-original-title="Twitter" class="tooltip-test"><i
									class="fa fa-twitter"></i></a> <a data-original-title="Google Plus"
									class="tooltip-test"><i class="fa fa-google-plus"></i></a>
							</div>
							<a class="btn  contact"><i class="fa fa-envelope-o"></i>
								Contact</a>
						</div>
					</div>
				</li>
	...
	<div class="row mt40">
		<div class="column3 premiumlisting">
			<ul id="premiumlisting">
				<li><a href="listing.html" class="listing"> <img
						src="img/list1.jpg" alt=""> <span class="caption">Computer
							Listing</span>
				</a></li>
				<li><a href="listing.html" class="listing"> <img
						src="img/list2.jpg" alt=""> <span class="caption">For
							Rent</span>
				</a></li>
				<li><a href="listing.html" class="listing"> <img
						src="img/list3.jpg" alt=""> <span class="caption">For
							Pets</span>
				</a></li>
				<li><a href="listing.html" class="listing"> <img
						src="img/list4.jpg" alt=""> <span class="caption">Mobiles</span>
				</a></li>
				<li><a href="listing.html" class="listing"> <img
						src="img/list5.jpg" alt=""> <span class="caption">Camera
							Listing</span>
				</a></li>
				<li><a href="listing.html" class="listing"> <img
						src="img/list6.jpg" alt=""> <span class="caption">Music
							Listing</span>
				</a></li>
				<li><a href="listing.html" class="listing"> <img
						src="img/list3.jpg" alt=""> <span class="caption">Premium
							Listing</span>
				</a></li>
				<li><a href="listing.html" class="listing"> <img
						src="img/list4.jpg" alt=""> <span class="caption">Premium
							Listing</span>
				</a></li>
			</ul>
			<div class="clearfix"></div>
			<a id="prevpre" class="prepre" href="#">Previous</a> <a id="nextpre"
				class="nextpre" href="#">Next</a>
		</div>
	</div>
</div>
<div class="container mt40">
		...
		<div class="col-lg-12">
			<ul id="myTab" class="nav nav-tabs home-2">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown">Other countries <b class="caret"></b></a>
			...
			<div class="tab-content mytab">
				<div class="tab-pane" id="popularcities">
					...
					<ul class="citylist">
						<c:forEach items="${activeStateList}" var="activeState">

							<li><a href="./state/${activeState.value}/">${activeState.value}</a></li>
...
<div class="container mt40">
	...
	<div class="row mt40">
		...
		<div class="col-md-3 col-sm-6">
			<h5 class="heading5">
				<span class="maintext">Latest Blog</span>
			</h5>
			<div id="latestblog">
				<ul>
					<li><img class="pull-left" width="100" title="blog" alt="blog"
						src="img/blog1.jpg">
						<div class="blogdate">
							<span class="blogicon"><i class="fa fa-calendar"></i>
								September 5, 2013 </span> <span class="blogicon"><a><i
									class="fa fa-comment"></i> 5 Comments</a> </span> <span class="blogicon"><a
								class="orange"><i class="fa fa-user"></i> by : pxcreate </a> </span>
						</div> <a href="blog.html" class="blogtitle">Lorem Ipsum is simply
							dummy...</a></li>
					<li><img class="pull-left" width="100" title="blog" alt="blog"
						src="img/blog1.jpg">
						<div class="blogdate">
							<span class="blogicon"><i class="fa fa-calendar"></i>
								September 5, 2013 </span> <span class="blogicon"><a><i
									class="fa fa-comment"></i> 5 Comments</a> </span> <span class="blogicon"><a
								class="orange"><i class="fa fa-user"></i> by : pxcreate </a> </span>
						</div> <a href="blog.html" class="blogtitle">Dummy text of the
							printing text...</a></li>
					<li><img class="pull-left" width="100" title="blog" alt="blog"
						src="img/blog1.jpg">
						<div class="blogdate">
							<span class="blogicon"><i class="fa fa-calendar"></i>
								September 5, 2013 </span> <span class="blogicon"><a><i
									class="fa fa-comment"></i> 5 Comments</a> </span> <span class="blogicon"><a
								class="orange"><i class="fa fa-user"></i> by : pxcreate </a> </span>
						</div> <a href="blog.html" class="blogtitle">Printing and
		...
		<div class="col-md-3 col-sm-6 mt40column">
			...
			<div id="latestnews">
				<ul>
					<li>
						<div class="date">
							<span class="datetext">25</span><br> March 2014
						</div> Lorem Ipsum is simply dummy text of the printing and typesetting
						dummy text of industry. <a href="#"> Read more</a>
					</li>
					<li>
						<div class="date">
							<span class="datetext">05</span><br> Jan 2014
						</div> Contrary to popular belief, Lorem Ipsum is not simply random
						text. It has roots in a Latin.<a href="#"> Read more</a>
					</li>
					<li>
						<div class="date">
							<span class="datetext">18</span><br> Feb 2014
						</div> Lorem Ipsum is simply dummy text of the printing and typesetting
						dummy text of industry. <a href="#"> Read more</a>
					</li>
					<li>
						<div class="date">
							<span class="datetext">30</span><br> Dec 2013
						</div> The standard chunk of Lorem Ipsum used since the 1500s is
						reproduced those interested. <a href="#"> Read more</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="col-md-3 col-sm-6 mt40column">
			<h5 class="heading5">
				<span class="maintext"> Faq</span>
			</h5>
			<div id="faq" class="mt15r">
				<ul>
					<li><a class="question accrodian-trigger-faq"> What is
							lorem Ipsum ?</a>
						<div class="answer accrodian-data-faq">
							<p>
								<i class="fa fa-share-alt"></i> Lorem Ipsum is simply dummy text
								of the printing and typesetting industry. Lorem Ipsum has been
								the industry's standard 1500s, when an unknown printer took a
								galley of type.
							</p>
						</div></li>
					<li><a class="question accrodian-trigger-faq"> What is
						...
						<div class="answer accrodian-data-faq">
							<p>
								<i class="fa fa-share-alt"></i> Contrary to popular belief,
					...
					<li><a class="question accrodian-trigger-faq"> What is
						...
						<div class="answer accrodian-data-faq">
							<p>
								<i class="fa fa-share-alt"></i>Lorem Ipsum has been the
		...
		<div class="col-md-3 col-sm-6 mt40column">
			<h5 class="heading5">
				<span class="maintext"> What Client's Say</span>
			</h5>
			<ul class="latesttestimonials">
				<li><img class="imageleft" width="50" height="50"
					src="img/avtar.jpg" alt="user" title="user">
					<div class="detail">
						"The standard chunk of Lorem Ipsum used since the 1500s is
						reproduced interested. " <br> by : <span class="orange">pxcreate</span>
					</div></li>
				<li><img class="imageleft" width="50" height="50"
					src="img/avtar.jpg" alt="user" title="user">
					<div class="detail">
						" Lorem Ipsum is simply dummy text of the printing and typesetting
						industry. "<br> by : <span class="orange">pxcreate</span>
					</div></li>
				<li><img class="imageleft" width="50" height="50"
					src="img/avtar.jpg" alt="user" title="user">
					<div class="detail">
						"It is a long established fact that a reader will be distracted by
						the readable content of a page." <br> by : <span
							class="orange">pxcreate</span>
					</div></li>
			</ul>
		</div>
	</div>
...
<div class="container">
		...
		<ul class="row clearfix">
			...
			<li class="col-md-3 col-sm-6 mt40column">
				...
				<div class="social-feed flickr-feed">
					<img src="img/photo1.jpg" alt="" title="" /> <img
						src="img/photo2.jpg" alt="" title="" /> <img src="img/photo3.jpg"
						alt="" title="" /> <img src="img/photo4.jpg" alt="" title="" /> <img
						src="img/photo4.jpg" alt="" title="" /> <img src="img/photo2.jpg"
						alt="" title="" /> <img src="img/photo1.jpg" alt="" title="" /> <img
						src="img/photo3.jpg" alt="" title="" /> <img src="img/photo1.jpg"
						alt="" title="" /> <img src="img/photo2.jpg" alt="" title="" /> <img
						src="img/photo3.jpg" alt="" title="" /> <img src="img/photo4.jpg"
						alt="" title="" /> <img src="img/photo2.jpg" alt="" title="" /> <img
						src="img/photo4.jpg" alt="" title="" /> <img src="img/photo3.jpg"
						alt="" title="" /> <img src="img/photo1.jpg" alt="" title="" />
				</div>
			</li>
			<li class="col-md-3 col-sm-6 mt40column">
  ...
  fjs.parentNode.insertBefore(js, fjs);
					...
					<div class="fb-like-box"
						data-href="https://www.facebook.com/facebook" data-width="240"
						data-show-faces="true" data-colorscheme="light"
						data-stream="false" data-show-border="false" data-header="false"
						data-height="240"></div>
				</div>
			</li>
		</ul>
					...
					<form class="form-inline">
						<div class="input-prepend">
							<input type="text" class="subscribeinput" id="inputIcon"
								placeholder="Subscribe to Newsletter"> <input
								type="submit" class="btn btn-orange" value="Subscribe">
						</div>
					</form>
				</div>
			</div>
