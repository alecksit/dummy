...
<!-- Mirrored from www.pxcreate.com/bootstrap/classic/blog.html by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 14 Jul 2015 12:03:19 GMT -->
<head>
      ...
      <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 mt40column"> 
        ...
        <div class="" id="bloglist">
          <div class="bloglisting list">
            <ul>
              <li class="clearfix blogfull">
                <div class="clearfix blogfulltop">
                  ...
                  <div class="col-sm-8">
                    <h3><a class="title" href="#">Your First Blog With Slider </a></h3>
                    <ul class="icondetail">
                    ...
                    <div class="tag">
                      <ul class="tags">
                        <li><a><i class="fa fa-tag"></i> Food</a> </li>
                        <li><a><i class="fa fa-tag"></i> Real Estate</a> </li>
                        <li><a><i class="fa fa-tag"></i> Hobbiies</a> </li>
                        <li><a><i class="fa fa-tag"></i> Electronics</a> </li>
                        <li><a><i class="fa fa-tag"></i> Services</a> </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-sm-2">
                ...
                <div class="discrption">
                  <div class="flexslider mb20" id="blogslider">
                    <ul class="slides">
                      <li> <img src="img/product1big.jpg" alt="" /> </li>
                      <li> <img src="img/product2big.jpg" alt="" /> </li>
                    </ul>
                  </div>
                  <div class="mt40"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. <br>
                    <br>
              ...
              <li class="clearfix blogfull">
                <div class="clearfix blogfulltop">
                  <div class="col-sm-2"> <a class="thumbnail" href="detail.html"><img src="img/product1.jpg" alt=""></a>
                    <div class="personal category color7"> <i class="fa fa-user"></i> Category</div>
                  </div>
                  <div class="col-sm-8">
                    <h3><a class="title" href="#">Your Second Blog With Image </a></h3>
                    <ul class="icondetail">
                      <li><i class="fa fa-calendar"></i> Posted On : Mach 22, 2014 </li>
                      <li><i class="fa fa-user"></i> Posted by : <a href="#">pxcreate</a></li>
                    </ul>
                ...
                <div class="discrption">
                  <div class="blogimage"><img src="img/product3big.jpg" alt="" /> </div>
                  <div class="mt40"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. <br>
                    <br>
                    It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. <br>
                    <br>
