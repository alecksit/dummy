...
<!-- Mirrored from www.pxcreate.com/bootstrap/classic/detail.html by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 14 Jul 2015 12:03:22 GMT -->
<head>
...
<div id="maincontainer"> 
  ...
  <div class="container"> 
    ...
    <ul class="breadcrumb">
      ...
      <li class="active"> Samsung Galaxy S Duos 2 S7582</li>
    </ul>
    
    <!-- Title-->
    
    <h2 class="heading3 mt40"> Samsung Galaxy S Duos 2 S7582 </h2>
    ...
    <div class="row mt40"> 
      ...
      <div class="col-lg-5 col-md-5 col-xs-12 col-sm-12">
        <ul class="thumbnails mainimage clearfix">
          <li> <img class="my-foto-container" src="img/product1big.jpg"  data-large="img/product1big.jpg" data-title="Your Product Name"  alt="Your Product Name" data-help="Your Product Name" title="Your Product Name" /> </li>
        </ul>
        <ul class="thumbnails mainimage clearfix mt10">
          <li class="producthtumb col-lg-3 col-md-3 col-xs-3 col-sm-3"> <img class="zoom" src="img/product1big.jpg" data-large="img/product1big.jpg" data-title="Your Product Name"  alt="Your Product Name" data-help="Your Product Name" title="Your Product Name"></li>
          <li class="producthtumb col-lg-3 col-md-3 col-xs-3 col-sm-3"> <img class="zoom" src="img/product2big.jpg" data-large="img/product2big.jpg" data-title="Your Product Name"  alt="Your Product Name" data-help="Your Product Name" title="Your Product Name"></li>
          <li class="producthtumb col-lg-3 col-md-3 col-xs-3 col-sm-3"> <img class="zoom" src="img/product1big.jpg" data-large="img/product1big.jpg" data-title="Your Product Name"  alt="Your Product Name" data-help="Your Product Name" title="Your Product Name"></li>
          <li class="producthtumb col-lg-3 col-md-3 col-xs-3 col-sm-3"> <img class="zoom" src="img/product2big.jpg" data-large="img/product2big.jpg" data-title="Your Product Name"  alt="Your Product Name" data-help="Your Product Name" title="Your Product Name"></li>
        </ul>
      ...
      <div class="col-lg-7 col-md-7 col-xs-12 col-sm-12 mt40column">
        <div class="clearfix">
          <div class="price pull-left"> <i class="fa fa-tags"></i> $480.00</div>
          <a class="pull-right btn btn-orange btn-lg">Contact</a> </div>
        ...
        <div class="productdesc">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="description">
              <h2 class="m0">Discripiton Titles</h2>
              Lorem Ipsum is simply dummy text of the printing and typesetting industry. <br>
              <ul class="listoption3">
                <li> Android v4.2 (Jelly Bean) OS</li>
            ...
            <div class="tab-pane " id="specification">
              <ul class="productinfo">
                <li> <span class="productinfoleft"> Brand:</span> Samsung </li>
                <li> <span class="productinfoleft"> Model Name:</span> Galaxy S Duos 2 </li>
                <li> <span class="productinfoleft"> SIM Type: </span> Dual SIM, GSM + GSM </li>
                <li> <span class="productinfoleft"> Old Price: </span> $500.00 </li>
                <li> <span class="productinfoleft"> Touch Screen: </span> Yes, Capacitive</li>
                <li> <span class="productinfoleft"> Ex Tax: </span> $500.00 </li>
                <li> <span class="productinfoleft"> Call Features:</span> Loudspeaker </li>
                <li> <span class="productinfoleft"> Handset Color:</span> Pure White </li>
              </ul>
            </div>
    ...
    <div class="mt40" id="serchlist">
      <h2 class="heading3">Recommended Combos for Samsung Galaxy S Duos</h2>
      <div class="searchresult list mt40">
        <ul>
          <li class="clearfix">
            ...
            <div class="col-sm-8">
              ...
              <ul class="icondetail">
                ...
                <li><i class="fa fa-map-marker"></i> Location : <a href="#">California, U.S.</a></li>
