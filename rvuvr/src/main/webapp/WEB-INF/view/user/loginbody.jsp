...
<!-- Mirrored from www.pxcreate.com/bootstrap/classic/login.html by HTTrack Website Copier/3.x [XR&CO'2013], Tue, 14 Jul 2015 12:02:47 GMT -->
<head>
        ...
        <div class="loginbox">
          <form class="form-vertical">
            <fieldset>
              ...
              <br>
              <a class="btn btn-orange">Login</a>
            </fieldset>
          </form>
        </div>
      </div>
